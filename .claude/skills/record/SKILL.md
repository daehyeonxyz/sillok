---
name: record
description: Maintain a naite learning context with help, study, course, query, lint, and curate workflows.
---
...
| Subcommand | Use | Load |
|---|---|---|
| `help` | First-run guide. Explains naite in friendly Korean and routes the learner by material type. | `<SKILL_DIR>/help.md` |
