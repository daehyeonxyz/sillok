...
Sillok has one first-run guide, three daily-use workflows, and two maintenance workflows.

## /record help

Use this when the learner asks how to start.

Help should explain Sillok in friendly Korean, then route by material type:
...
Sillok can later grow advanced workflows such as ingest or decision capture. They are intentionally not part of the beginner surface.
