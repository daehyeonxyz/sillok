# CONVENTIONS.md - Sillok Operating Rules

These rules apply whenever an agent changes `notes/`.

Sillok should stay simple enough for a new learner to use, while still preserving enough structure for LLM agents to maintain the notes over time.
...
Sillok has two maintenance tracks:
